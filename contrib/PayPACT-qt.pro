...
RESOURCES += src/qt/PayPACT.qrc src/qt/PayPACT_locale.qrc

TRANSLATIONS += src/qt/locale/PayPACT_bg.ts \
                src/qt/locale/PayPACT_de.ts \
                src/qt/locale/PayPACT_en.ts \
                src/qt/locale/PayPACT_es.ts \
                src/qt/locale/PayPACT_fi.ts \
                src/qt/locale/PayPACT_fr.ts \
                src/qt/locale/PayPACT_it.ts \
                src/qt/locale/PayPACT_ja.ts \
                src/qt/locale/PayPACT_pl.ts \
                src/qt/locale/PayPACT_pt.ts \
                src/qt/locale/PayPACT_ru.ts \
                src/qt/locale/PayPACT_sk.ts \
                src/qt/locale/PayPACT_sv.ts \
                src/qt/locale/PayPACT_vi.ts \
                src/qt/locale/PayPACT_zh_CN.ts \
                src/qt/locale/PayPACT_zh_TW.ts
