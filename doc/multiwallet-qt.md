...
In order to support loading of multiple wallets in PayPACT-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is PayPACT.cpp.
...
Changes to PayPACT.cpp
----------------------
PayPACT.cpp is the entry point into PayPACT-qt, and as such, will require some minor modifications to provide hooks for
