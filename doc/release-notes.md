PayPACT Core version 2.2.1 is now available from:

  <https://github.com/PayPACT-project/PayPACT/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/PayPACT-project/PayPACT/issues>

Compatibility
==============

PayPACT Core is extensively tested on multiple operating systems using
...
PayPACT Core should also work on most other Unix-like systems but is not
...
of Bitcoin that PayPACT was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/PayPACT-project-translations/).
