                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("PayPACT Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a PayPACT address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and PayPACT: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About PayPACT Core"), this);
    aboutAction->setStatusTip(tr("Show information about PayPACT Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for PayPACT"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PayPACT addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PayPACT addresses"));
    ...
    openAction->setStatusTip(tr("Open a PayPACT: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the PayPACT Core help message to get a list with possible PayPACT command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("PayPACT Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PayPACT network", "", count));
}
...
{
    QString strTitle = tr("PayPACT Core"); // default title
