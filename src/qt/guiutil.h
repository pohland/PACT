...
/** Utility functions used by the PayPACT Qt UI.
 */
namespace GUIUtil
{
...
// Render PayPACT addresses in monospace font
...
// Parse "PayPACT:" URI into recipient object, return true on successful parsing
