...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "PayPACT server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* PayPACT features */
        {"PayPACT", "masternode", &masternode, true, true, false},
        {"PayPACT", "masternodelist", &masternodelist, true, true, false},
        {"PayPACT", "mnbudget", &mnbudget, true, true, false},
        {"PayPACT", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"PayPACT", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"PayPACT", "mnsync", &mnsync, true, true, false},
        {"PayPACT", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"PayPACT", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use PayPACTd, or the -server option to PayPACT-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> PayPACT-cli " + methodname + " " + args + "\n";
}
