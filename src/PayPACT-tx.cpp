...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("PayPACT Core PayPACT-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  PayPACT-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded PayPACT transaction") + "\n" +
                               "  PayPACT-tx [options] -create [commands]   " + _("Create hex-encoded PayPACT transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded PayPACT transaction
