Contributing to PayPACT Core
============================

The PayPACT Core project operates an open contributor model where anyone is
...
The following applies to code changes to the PayPACT Core project, and is not to be
confused with overall PayPACT Network Protocol consensus changes.

Whether a pull request is merged into PayPACT Core rests with the project merge
...
Patches that change PayPACT consensus rules are considerably more involved than
...
Where a patch set proposes to change the PayPACT consensus, it must have been
...
The project leader is the release manager for each PayPACT Core release.
